...
def gen_func_body(prop, inp, expected):
    ...
    str_list.append("\n")
    str_list.append(f"find_anagrams(is_anagram, candidates, {num_candidates}, \"{subject}\");\n")
    str_list.append("\n")
    str_list.append(f"TEST_ASSERT_EQUAL_INT_ARRAY(expected, is_anagram, {num_candidates});\n")
