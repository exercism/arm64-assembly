...
def gen_func_body(prop, inp, expected):
    ...
    if len(factors) > 0:
        ...
        str_list.append(f'TEST_ASSERT_EQUAL_UINT64({expected}, {prop}({limit}, factors, ARRAY_SIZE(factors)));\n')
    else:
        str_list.append(f'TEST_ASSERT_EQUAL_UINT64({expected}, {prop}({limit}, NULL, 0));\n')
